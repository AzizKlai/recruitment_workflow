...
public class SendCandidateDocsDelegate implements JavaDelegate {
    private static final String SERVICE_URL ="http://localhost:4002";
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String apiUrl = SERVICE_URL + "/generate_and_send_candidate_docs/1";// + candidateId;
    ...
    public static void main(String[] args) throws Exception {
        String apiUrl = SERVICE_URL + "/generate_and_send_candidate_docs/1";
        ...
        int responseCode = connection.getResponseCode();
        if (responseCode == HttpURLConnection.HTTP_OK) {
            System.out.println("Successfully generated and sent candidate documents for candidate ID: 1");
        } else {
            throw new RuntimeException("Failed to generate candidate documents. HTTP Code: " + responseCode);
        }
    }
